...
setRightMargin(56);
    ...
    return (
      <div
        ...
        ref={rulerRef}
        className="h-6 border-b border-gray-300 flex items-end relatie select-none print:hidden"
      >
        <div
          id="ruler-container"
  ...
  const Marker = ({
    ...
    return (
      ...
      >
        <FaCaretDown className="absolute top-0 h-full fill-blue-500 left-1/2 transform -translate-x-1/2 -translate-y-1/2 " />
      </div>
    );
  };
